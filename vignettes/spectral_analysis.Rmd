...
```{r REDFIT}
out.redfit <-  redfit(x=X,t=t,tType="age",mctest = FALSE,n50=2,nsim=200) 
redfit.df <- data.frame("freq" = out.redfit$freq, "pwr" = out.redfit$gxx)
# estimate significance against a power-law fit
f.low <-  1e-3; f.high <- 0.1
plaw.ls <-  astrochron::pwrLawFit(redfit.df, dof = 2, flow = f.low, fhigh = f.high, output = 1, genplot = F)
