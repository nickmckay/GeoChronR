...
If you don't have lipdR yet, then we can use the preloaded version of the dataset included in the package

```{r}
if (requireNamespace("lipdR", quietly = TRUE)) {#if you have lipdR, you can load it this way
hulu <- lipdR::readLipd(system.file("extdata", "Hulucave.Wang.2001.lpd", package = "geoChronR"))
