...
Also notable is that the confidence limits affect peak detection very differently here; only the eccentricity cycle near 100k rises above the 95% and 99% level; other cycles are sumarily dismissed. You can tweak the range over which this power law is fit and it will not change much.
...
To conclude, we must emphasize that hunting for astronomical (or other) frequencies in paleoclimate timeseries takes extreme care, and cannot be answered in one function call. Depending on the goals and applications, readers might want to consider the work of Stephen Meyers:
- Meyers, 2015
